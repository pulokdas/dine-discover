                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-4" >
                        ...
                        <button onClick={handleSubmit}
                            ...
                            className="w-full text-white bg-red-600 hover:bg-teal-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:bg-opacity-70 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                        >
                            Create Account
                        </button>
